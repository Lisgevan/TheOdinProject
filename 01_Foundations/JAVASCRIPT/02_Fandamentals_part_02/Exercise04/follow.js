...
//added "export" to all const variables and the next 3 to make code work
export const fullName = firstName + " " + lastName;
export const age = thisYear - birthYear;
export const testGroup = "a";

// //step 01 to run the code - COMPLETED -
...
// //step 02 - COMPLETED
// export const greeting = `Hello! My name is ${firstName} ${lastName} and I am ${thisYear - birthYear} years old.`;

//step 03 - COMPLETED
export const greeting = `Hello! My name is ${fullName} and I am ${age} years old.`;
